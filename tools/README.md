...
- `math-translator`：`beta`，單頁工作台、通用數學詞庫、公開試／出版社題型及教學語境示例；可在本地 server 模式匯入 DOCX、PDF 及可供檢視的 Google Docs，並選用 GPT-5.6 Luna、MiniMax、LocalAI 或其他 OpenAI-compatible LLM。
